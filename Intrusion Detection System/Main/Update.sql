...
DECLARE
	...
	LBL FrequentPackets.Label%TYPE := '&new_label';
	Freq FrequentPackets.Frequency%TYPE := '&new_frequency';
BEGIN
	Update_Procedure(A,B,C,D,E,F,LBL, Freq);
	--DBMS_OUTPUT.PUT_LINE(LBL || ' '|| Freq);
END;
/